...
The research poster presented at the 2026 California Neurotechnology Conference (CNTC) @UC Berkeley, which details a brief project overview, is available [here](https://drive.google.com/file/d/1DYNPa0U_blKSx-6KFc1fAIsUNBEod6rd/view) or within the repository file, `sEMG Prosthetic Hand - Iron Man TNT.pdf`.
...
**Brain-computer interface (BCI):** a system that translates physiological signals into commands for an external device.
...
4. A BiLSTM network automatically extracts features and classifies the corresponding gesture.
5. GUI sends specific servo motion commands via Arduino over WiFi to the servos in the fingers for live control.
...
- Modular arm component with wrist rotation

## Results
 
- 97 percent gesture classification accuracy across users, with 250 milliseconds execution
- Functional prosthetic arm with fluid, continuous finger movement
- Fully accessible GUI supporting data collection, model training, and live execution
- Estimated fabrication and hardware cost approximately 50 times lower than a comparable commercial prosthetic arm

## Gesture Set
 
The current implementation trains and classifies a set of 5 predefined gestures; extending the set toward the target of 8+ gestures is an active area of development.
...
| `sEMG Prosthetic Hand - Iron Man TNT.pdf` | Project poster presented at the 2026 California Neurotechnology Conference @UC Berkeley, summarizing the project overview. |
...
Triton NeuroTech @UC San Diego: Project leads & project members | Contributions span mechanical design and 3D printing, embedded firmware, sEMG signal processing, and machine learning.
